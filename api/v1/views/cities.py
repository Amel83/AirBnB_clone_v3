#!/usr/bin/python3
'''
API for City objects, supporting RESTful operations.
'''
...
def get_cities_by_state(state_id):
    '''
    Retrieves the list of all City objects of a specific State by its ID.
    '''
...
def bad_request(error):
    '''
    Bad Request: Invalid request to the API.
    '''
